...
float leerFlotanteMayor(char*mensaje, float lim){
    float valor;
    do{
        printf("%s", mensaje);
        scanf("%f",&valor);
...
float leerFlotanteMenor(char*mensaje, float lim){
    float valor;
    do{
        printf("%s", mensaje);
        scanf("%f",&valor);
...
int leerEnteroMayor(char*mensaje, int lim){
    int valor;
    do{
        printf("%s", mensaje);
        scanf("%d",&valor);
...
int leerEnteroMenor(char*mensaje, int lim){
    int valor;
    do{
        printf("%s", mensaje);
        scanf("%d",&valor);
